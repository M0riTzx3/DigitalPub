    ...
    <form action="/signUp" th:object="${user}" method="post">
        <div class="col-md-12 text-center" id="signUpWrapper">
            <div class="input-group input-group-md col-sm-offset-4 col-sm-4">
                <input th:field="*{email}" name="email" type="email" class="center-block form-control input-lg"  title="Enter you email." placeholder="Enter your email address">
            </div>
            <br>
            <div class="input-group input-group-md col-sm-offset-4 col-sm-4">
                <input th:field="*{username}" name="username" type="text" class="center-block form-control input-lg" title="Enter nickname" placeholder="Enter nickname">
            </div>
            <br>
            <div class="input-group input-group-md col-sm-offset-4 col-sm-4">
                <input th:field="*{password1}" name="password_1" type="password" class="center-block form-control input-lg" title="Enter password" placeholder="Enter password">
            </div>
            <br>
            <div class="input-group input-group-md col-sm-offset-4 col-sm-4">
                <input th:field="*{password2}" name="password_2" type="password" class="center-block form-control input-lg" title="Repeat password" placeholder="Repeat password">
            </div>
            <br>
